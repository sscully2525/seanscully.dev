...
const experiences = [
  {
    ...
    highlights: [
      ...
      'Redesigned memory architecture from Postgres connection pooling to Redis-based solution, eliminating latency and connection contention under concurrent load',
      'Proactively researched LangChain source code and open PRs to creatively solve tooling limitations rather than treating them as blockers',
      'Developed working agent prototype and Streamlit UI for early FP&A demos, rapidly learning agent architecture, LangGraph, memory, state management, and context engineering',
      'Positioned Curie as a long-term FP&A assistant handling complex multi-database queries with retained context and continuous improvement capabilities',
      'Presented Curie concept to senior leadership, receiving strong approval to move forward as a global solution',
    ],
  },
  {
    company: 'Marsh McLennan',
